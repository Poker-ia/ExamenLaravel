...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body>
    @include('layouts.nav')
        ...
        <h2 style="font-size: 40px;" class="text-center text-[40px] font-extrabold ">Cursos</h2>
...
<div id="crud-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" method="POST" action="{{ route('cursos.store') }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="titulo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titulo</label>
                        <input type="text" name="titulo" id="titulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Nombre del Curso" required="">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="plataforma_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Plataforma</label>
                        <select  name="plataforma_id" id="plataforma_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <img class="w-20" src="{{ asset('storage/'.$curso->imagen) }}" alt="">
                </td>
                <td class="px-6 py-4">
                    {{ $plataformas->find($curso->plataforma_id)->nombre }}
                </td>
                <td class="px-6 py-4  flex gap-5">
                   <div>
    <button data-modal-target="crud-modal-{{ $curso->id }}" data-modal-toggle="crud-modal-{{ $curso->id }}" type="button">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
    ...
    <!-- Main modal -->
    <div id="crud-modal-{{ $curso->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal-{{ $curso->id }}">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="POST" action="{{ route('cursos.update', $curso->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            >
                                ...
                                @foreach ($plataformas as $plataforma)
                                    <option value="{{ $plataforma->id }}" {{ old('plataforma_id', $curso->plataforma_id) == $plataforma->id ? 'selected' : '' }}>
                                        {{ $plataforma->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea 
                                ...
                                name="descripcion" 
                                rows="4" 
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                        ...
                        <div class="col-span-2">
                            ...
                            >
                            @if ($curso->imagen)
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Imagen actual:</p>
                                <img src="{{ asset('storage/' . $curso->imagen) }}" alt="Imagen del curso" class="w-32 mt-1 rounded">
                            @endif
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @csrf
                        @method('DELETE')
                            <button type="submit"><?xml version="1.0" ?><!DOCTYPE svg  PUBLIC '-//W3C//DTD SVG 1.1//EN'  'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
